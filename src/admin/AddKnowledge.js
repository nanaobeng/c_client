...
const clickSubmit = (event) => {
    ...
    formData.set('category','knowledge')
    console.log(formData)

    createInsight(user._id,token,formData)
    .then(data => {
        if(data.error){
...
const newPostForm = () => (
    <form className="mb-3" onSubmit={clickSubmit}>
        ...
        <div className="form-group">
            ...
            <input onChange={handleChange('photo')} type="file" className="form-control"name="photo" accept="application/pdf" />
            </label>
        </div>
        <div className="form-group">
      ...
      />
        ...
        <button className="btn btn-outline-primary"> Add Insight</button>
...
<h1> Add Insights( Knowledge Bank )</h1>
