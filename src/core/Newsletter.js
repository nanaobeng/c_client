  ...
  <ul>
    ...
    <li class="drop-down active"><a href="">Insights</a>
            <ul>
              ...
              <li className="active"><Link to="/insights/newsletters"> Newsletters</Link></li>
...
{isAuthenticated() && ( <nav class="nav-menu d-none d-lg-block">
  <ul>
    ...
    <div className="row ">
       ...
       <h3 style={{color:'#C5303C'}}>Newsletters</h3>
...
<div class="row ">
  ...
  {filteredResults.map((insight,i)=> (
       insight.category === 'newsletter' && <div className="parent col-md-4 col-sm-6 p-4">
...
{filteredResults.length < 1 && (<div className="col-12 pt-4"> <b>There are currently no insights uploaded.</b></div>)}
